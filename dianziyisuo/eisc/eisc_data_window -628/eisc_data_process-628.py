...
class MainWindow:
	def __init__(self):
		...
		self.excel_filepath.set('Z:/ALLPDF/AD-FULLTXT/2018006/AD-2016.total.xls')
		...
		self.actual_filepath.set('Z:/ALLPDF/AD-FULLTXT/2018006/AD')
		...
		self.filepath_in_computer.set('/AD-FULLTXT/2018006/AD')
		...
		self.value_year_combobox['values'] = ('', '出版年', 'Year', 'YEAR')
		...
		self.value_mtitle_combobox['values'] = ('', '标题', 'Title', 'TITLE')
		...
		self.value_authors_combobox['values'] = ('', '作者', 'Author', 'authors', 'Authors')
		...
		self.value_keyword_combobox['values'] = ('', '关键词', 'Keyword')
		...
		self.value_abstracts_combobox['values'] = ('', '文摘', 'Abstract')
		...
		self.value_bepage_combobox['values'] = ('', '页码', 'strPage')
		...
		self.value_filename_combobox['values'] = ('', 'PDF', 'filename')
		...
		self.value_isbn_combobox.current(2)
		...
		self.value_pubdate_combobox['values'] = ('', '出版年', 'publicationDate', 'issueDate')
