...
class MainWindow:
	def __init__(self):
		...
		self.excel_filepath.set('Z:\\ALLPDF\\IELDVD\\2018006\\工作簿5.xlsx')
		...
		self.actual_filepath.set('Z:\\ALLPDF\\IELDVD\\2018006\\PDF')
		...
		self.report_name_combobox['values'] = ('IEL', 'SPIE', 'AIAA', 'IQPC', 'AD', 'DE', 'PB', 'NASA',
		                                       ...
		                                       '预留数据库', '自建库')
		self.report_name_combobox.current(0)
		...
		self.filepath_in_computer.set('\\IELDVD\\2018006\\PDF')
		...
		self.value_vol_combobox.current(0)
		...
		self.value_issue_combobox.current(0)
		...
		self.value_doi_combobox.current(0)
		...
		self.value_year_combobox['values'] = ('YEAR', '出版年', 'Year', 'YEAR')
		self.value_year_combobox.current(0)
		...
		self.value_mtitle_combobox['values'] = ('TITLEPROPER', '标题', 'Title', 'TITLE')
		self.value_mtitle_combobox.current(0)
		...
		self.value_authors_combobox['values'] = ('AUTHOR', '作者', 'Author', 'authors', 'Authors')
		self.value_authors_combobox.current(0)
		...
		self.value_authorunit_combobox['values'] = ('', '作者单位', 'Organ')
		self.value_authorunit_combobox.current(0)
		...
		self.value_keyword_combobox['values'] = ('FREETERM', '关键词', 'Keyword')
		self.value_keyword_combobox.current(0)
		...
		self.value_abstracts_combobox['values'] = ('ABSTRACT', '文摘', 'Abstract')
		self.value_abstracts_combobox.current(0)
		...
		self.value_pages_combobox.current(0)
		...
		self.value_bepage_combobox['values'] = ('DOCUMENTPAGES', '页码', 'strPage')
		self.value_bepage_combobox.current(0)
		...
		self.value_filename_combobox['values'] = ('FILENAME', 'PDF', 'filename')
		self.value_filename_combobox.current(0)
		...
		self.value_filesize_combobox.current(0)
		self.value_filesize_combobox.grid(row=4, column=1)

		# 这个地方出过BUG，不要讲file_path写成filepath
		self.value_file_path_label = ttk.Label(self.frame_value, text='file_path:').grid(row=4, column=2)
		self.value_file_path = StringVar()
		self.value_file_path_combobox = ttk.Combobox(self.frame_value, textvariable=self.value_file_path,
		                                            width=self.combobox_width)
		self.value_file_path_combobox['values'] = ('','FILERELPATH')
		self.value_file_path_combobox.current(0)
		self.value_file_path_combobox.grid(row=4, column=3)

		self.value_filepath_level_label = ttk.Label(self.frame_value, text='filepath_level:').grid(row=4, column=4)
		self.value_filepath_level = StringVar()
		self.value_filepath_level_combobox = ttk.Combobox(self.frame_value, textvariable=self.value_filepath_level,
		                                            width=self.combobox_width)
		self.value_filepath_level_combobox['values'] = ('','1', '2', '3')
		self.value_filepath_level_combobox.current(0)
		self.value_filepath_level_combobox.grid(row=4, column=5)
		...
		self.value_isbn_combobox.current(0)
		...
		self.value_issn_combobox.current(0)
		...
		self.value_sourcename_combobox['values'] = ('PERIODICAL', 'journalname', 'JournamlName', 'MeetingName', 'meetingname')
		self.value_sourcename_combobox.current(0)
		...
		self.value_pubunit_combobox['values'] = ('', '出版机构', 'PubUnit')
		self.value_pubunit_combobox.current(0)
		...
		self.value_pubaddress_combobox.current(0)
		...
		self.value_pubdate_combobox['values'] = ('PUBYEAR', '出版年', 'publicationDate', 'issueDate')
		self.value_pubdate_combobox.current(0)
		...
		self.value_confaddress_combobox.current(0)
		...
		self.value_confdate_combobox.current(0)
		self.value_confdate_combobox.grid(row=7, column=3)

		# temp 字段
		self.value_temp01_label = ttk.Label(self.frame_value, text='temp01:').grid(row=8, column=0)
		self.value_temp01 = StringVar()
		self.value_temp01_combobox = ttk.Combobox(self.frame_value, textvariable=self.value_temp01, width=self.combobox_width)
		self.value_temp01_combobox['values'] = ('', 'MeetingDate', 'meetingdate')
		self.value_temp01_combobox.current(0)
		self.value_temp01_combobox.grid(row=8, column=1)

		self.value_temp02_label = ttk.Label(self.frame_value, text='temp02:').grid(row=8, column=2)
		self.value_temp02 = StringVar()
		self.value_temp02_combobox = ttk.Combobox(self.frame_value, textvariable=self.value_temp02, width=self.combobox_width)
		self.value_temp02_combobox['values'] = ('', 'MeetingDate', 'meetingdate')
		self.value_temp02_combobox.current(0)
		self.value_temp02_combobox.grid(row=8, column=3)

		self.value_temp03_label = ttk.Label(self.frame_value, text='temp03:').grid(row=8, column=4)
		self.value_temp03 = StringVar()
		self.value_temp03_combobox = ttk.Combobox(self.frame_value, textvariable=self.value_temp03, width=self.combobox_width)
		self.value_temp03_combobox['values'] = ('', 'MeetingDate', 'meetingdate')
		self.value_temp03_combobox.current(0)
		self.value_temp03_combobox.grid(row=8, column=5)

		self.value_temp04_label = ttk.Label(self.frame_value, text='temp04:').grid(row=9, column=0)
		self.value_temp04 = StringVar()
		self.value_temp04_combobox = ttk.Combobox(self.frame_value, textvariable=self.value_temp04, width=self.combobox_width)
		self.value_temp04_combobox['values'] = ('', 'MeetingDate', 'meetingdate')
		self.value_temp04_combobox.current(0)
		self.value_temp04_combobox.grid(row=9, column=1)

		self.value_temp05_label = ttk.Label(self.frame_value, text='temp05:').grid(row=9, column=2)
		self.value_temp05 = StringVar()
		self.value_temp05_combobox = ttk.Combobox(self.frame_value, textvariable=self.value_temp05, width=self.combobox_width)
		self.value_temp05_combobox['values'] = ('', 'MeetingDate', 'meetingdate')
		self.value_temp05_combobox.current(0)
		self.value_temp05_combobox.grid(row=9, column=3)

		self.value_temp06_label = ttk.Label(self.frame_value, text='temp06:').grid(row=9, column=4)
		self.value_temp06 = StringVar()
		self.value_temp06_combobox = ttk.Combobox(self.frame_value, textvariable=self.value_temp06, width=self.combobox_width)
		self.value_temp06_combobox['values'] = ('', 'MeetingDate', 'meetingdate')
		self.value_temp06_combobox.current(0)
		self.value_temp06_combobox.grid(row=9, column=5)

		self.value_temp07_label = ttk.Label(self.frame_value, text='temp07:').grid(row=10, column=0)
		self.value_temp07 = StringVar()
		self.value_temp07_combobox = ttk.Combobox(self.frame_value, textvariable=self.value_temp07, width=self.combobox_width)
		self.value_temp07_combobox['values'] = ('', 'MeetingDate', 'meetingdate')
		self.value_temp07_combobox.current(0)
		self.value_temp07_combobox.grid(row=10, column=1)

		self.value_temp08_label = ttk.Label(self.frame_value, text='temp08:').grid(row=10, column=2)
		self.value_temp08 = StringVar()
		self.value_temp08_combobox = ttk.Combobox(self.frame_value, textvariable=self.value_temp08, width=self.combobox_width)
		self.value_temp08_combobox['values'] = ('', 'MeetingDate', 'meetingdate')
		self.value_temp08_combobox.current(0)
		self.value_temp08_combobox.grid(row=10, column=3)

		self.value_temp09_label = ttk.Label(self.frame_value, text='temp09:').grid(row=10, column=4)
		self.value_temp09 = StringVar()
		self.value_temp09_combobox = ttk.Combobox(self.frame_value, textvariable=self.value_temp09, width=self.combobox_width)
		self.value_temp09_combobox['values'] = ('', 'MeetingDate', 'meetingdate')
		self.value_temp09_combobox.current(0)
		self.value_temp09_combobox.grid(row=10, column=5)

		self.value_corporateauthor_label = ttk.Label(self.frame_value, text='corporateauthor:').grid(row=11, column=0)
		self.value_corporateauthor = StringVar()
		self.value_corporateauthor_combobox = ttk.Combobox(self.frame_value, textvariable=self.value_corporateauthor, width=self.combobox_width)
		self.value_corporateauthor_combobox['values'] = ('', 'MeetingDate', 'meetingdate')
		self.value_corporateauthor_combobox.current(0)
		self.value_corporateauthor_combobox.grid(row=11, column=1)
	...
	def mainGetFieldToFieldDict(self):
		...
		field_to_field_dict['file_path'] = self.value_file_path.get()
		field_to_field_dict['filepath_level'] = self.value_filepath_level.get()
		...
		field_to_field_dict['temp01'] = self.value_temp01.get()
		field_to_field_dict['temp02'] = self.value_temp02.get()
		field_to_field_dict['temp03'] = self.value_temp03.get()
		field_to_field_dict['temp04'] = self.value_temp04.get()
		field_to_field_dict['temp05'] = self.value_temp05.get()
		field_to_field_dict['temp06'] = self.value_temp06.get()
		field_to_field_dict['temp07'] = self.value_temp07.get()
		field_to_field_dict['temp08'] = self.value_temp08.get()
		field_to_field_dict['temp09'] = self.value_temp09.get()
		field_to_field_dict['corporateauthor'] = self.value_corporateauthor.get()
	...
	def mainFileExist(self):
		...
		if fileExist(table_list, actual_filepath, field_to_field_dict):
	...
	def mainExcelDataChange(self):
		...
		data_list = excelDataChange(new_excel_file, report_name, report_type, field_to_field_dict)
		print(len(data_list))
	...
	def mainInsertErrorData(self):
		...
		count1 = insertErrorData(data_list, report_name)
		count2 = changeDocidById(report_name)

		if count1 == count2:
			msgb.showinfo('congragulate!',
			              'you have inserted %d data into s_data, please check if the number equal the error_num.')
